...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <a href="{{route('admin.teams.edit', $team)}}" class="btn btn-success me-4">Edit team</a>
            ...
            <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure you want to delete this team?')">Delete Team</button>
            </form>
                ...
                <a href="{{ route('admin.players.show', $player->id) }}" style="text-decoration: none; color: black;">
