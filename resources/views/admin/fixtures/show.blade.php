...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            {{-- link to the edit fixture view --}}
            <a href="{{route('admin.fixtures.edit', $fixture)}}" class="btn btn-success me-4">Edit Fixture</a>
            ...
            <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure you want to delete this fixture?')">Delete Fixture</button>
                ...
                <div class="row my-5">
                    ...
                    <div class="d-flex">
                        <a href="{{ route('admin.teams.show', $team->id) }}" class="noHover" style="text-decoration: none; color: black;">
